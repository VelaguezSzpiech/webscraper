...
class VisionCrawler:
    ...
    def get_url(self, prompt):
        ...
        while True:
            ...
            if os.path.exists("E:/Ai_Systems/pythonwebscraper/image/image.jpg"):
                os.remove("E:/Ai_Systems/pythonwebscraper/image/image.jpg")
            ...
            if not os.path.exists("E:/Ai_Systems/pythonwebscraper/image/image.jpg"):
        ...
        b64_image = self.image_b64("E:/Ai_Systems/pythonwebscraper/image/image.jpg")
...
if __name__ == "__main__":
    ...
    vision_crawler = VisionCrawler(api_key)
    prompt = input("You: ")
    vision_crawler.get_url(prompt)